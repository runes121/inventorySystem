...
def renderInventory():
    ...
    nameHeadingLabel = tk.Label(nameHeadingBorder, bg="white", text="Name", font=font.Font(weight="bold", size=12))
    ...
    reviewDateLabel = tk.Label(reviewDateBorder, text="Review by", bg="white", font=font.Font(weight="bold", size=12))
    ...
    stockNumLabel = tk.Label(stockNumBorder, text="In stock", bg="white", font=font.Font(weight="bold", size=12))
    ...
    for i, item in enumerate(inventory):
        ...
        nameCell = tk.Label(nameCellBorder, text=item['name'], bg="white", font=font.Font(size=12))
    ...
    totalStockLabel = tk.Label(totalStockLabelFrame, text="Total Stock:", bg="white", font=font.Font(weight="bold", size=12))
    ...
    totalStockText = tk.Label(totalStockTextFrame, text=str(totalStock), bg="white", font=font.Font(weight="bold", size=12))
...
def RecommendedNextOrder():
    ...
    if not RecommendedMode:
        ...
        nameHeader = tk.Label(nameHeaderBorder, text="Name", bg="white", font=font.Font(size=12, weight="bold"))
        ...
        stockHeader = tk.Label(stockHeaderBorder, text="In stock", bg="white", font=font.Font(size=12, weight="bold"))
        ...
        for i, item in enumerate(recommendedOrder):
            ...
            stockLabel = tk.Label(stockLabelBorder, text=str(item['stockNumber']), bg="white", font=font.Font(size=12))
